    ...
    requestJSON(requri, function(json) {
      if(json.message == "Not Found" || username == '') {
        ...
        function outputPageContent() {
          if(repositories.length == 0) { outhtml = outhtml + '<p class="title"><i class="fa fa-meh-o" aria-hidden="true"></i><br/>OOPS! No repos found by this '+repobytype.toLowerCase()+'!</p></div>';
            ...
            $.each(repositories, function(index) {
              ...
              {
                    case '01':lastUpdateMonth='Jan';
                                    break;
                     case '02':lastUpdateMonth='Feb';
                                    break;
                     case '03':lastUpdateMonth='Mar';
                                    break;
                     case '04':lastUpdateMonth='Apr';
                                    break;
                     case '05':lastUpdateMonth='May';
                                    break;
                     case '06':lastUpdateMonth='June';
                                    break;
                     case '07':lastUpdateMonth='July';
                                    break;
                     case '08':lastUpdateMonth='Aug';
                                    break;
                     case '09':lastUpdateMonth='Sept';
                                    break;
                     case '10':lastUpdateMonth='Oct';
                                    break;
                     case '11':lastUpdateMonth='Nov';
                                    break;
                       case '12':lastUpdateMonth='Dec';
                                    break;
                  default:lastUpdateMonth=' ';
